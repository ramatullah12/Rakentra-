...
<div class="container-fluid">
            ...
            <div class="card border-0 p-3" style="background:rgba(255,255,255,0.05);border-radius:16px;border:1px solid rgba(255,255,255,0.07);">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="text-white fw-bold fs-5">{{ $alats->total() }}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card border-0 mb-4" style="background:rgba(255,255,255,0.05);border-radius:20px;border:1px solid rgba(255,255,255,0.07);">
        <div class="card-body p-4">
            <form action="{{ route('alat.pemimpin') }}" method="GET">
                <div class="row g-3">
                    <div class="col-md-9">
                    ...
                    <div class="col-md-3 d-flex gap-2">
                        ...
                        <a href="{{ route('alat.pemimpin') }}" class="btn d-flex align-items-center justify-content-center"

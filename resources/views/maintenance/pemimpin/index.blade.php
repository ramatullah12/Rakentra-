...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <p class="text-secondary mb-0">
                Monitoring maintenance dan histori perbaikan alat berat
            </p>
            ...
            <div class="card border-0 shadow-sm"
                ...
                <div class="card-body">
                    ...
                    <h2 class="fw-bold text-danger">
                        ...
                        {{ $maintenances->where('status','pending')->count() }}
    ...
    <div class="card border-0 shadow-sm mb-4"
        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('maintenance.pemimpin') }}"
                  method="GET">
                    ...
                    @forelse($maintenances as $i => $maintenance)
                        ...
                        <tr style="background:rgba(255,255,255,0.03);
                            ...
                            <td class="text-secondary py-4">
                                ...
                                {{ Str::limit($maintenance->deskripsi_kerusakan, 45) }}

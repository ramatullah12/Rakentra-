...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
            <h4 class="fw-bold text-white mb-0">Buat Kontrak Baru</h4>
            <small class="text-secondary">Terbitkan dokumen kesepakatan penyewaan unit</small>
        </div>
    </div>
                    ...
                    <form action="{{ route('kontrak.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12 mb-2">
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    ...
                                    <h6 class="text-white fw-bold mb-0">Referensi Booking</h6>
                                </div>
                                <div class="p-3 rounded-4" style="background:rgba(15,23,42,0.3); border:1px solid rgba(255,255,255,0.05);">
                                    <label class="form-label text-secondary" style="font-size:12px;font-weight:600;">PILIH BOOKING AKTIF <span class="text-danger">*</span></label>
                                    <select name="booking_id" required class="form-select"
                                        ...
                                        <option value="">-- Pilih Booking Pelanggan --</option>
                                        @foreach($bookings as $booking)
                                            <option value="{{ $booking->id }}" {{ old('booking_id') == $booking->id ? 'selected' : '' }}>
                                                {{ $booking->pelanggan->nama }} - {{ $booking->alat->nama_alat }} ({{ \Carbon\Carbon::parse($booking->tanggal_mulai)->format('d M Y') }})
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="tanggal_kontrak" required class="form-control"
                                       ...
                                       value="{{ old('tanggal_kontrak', date('Y-m-d')) }}">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group" style="background:#0f172a;border:1px solid rgba(255,255,255,0.08);border-radius:12px;overflow:hidden;">
                                    <input type="number" name="durasi" required class="form-control border-0 text-white"
                                           ...
                                           placeholder="Contoh: 30" value="{{ old('durasi') }}">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group" style="background:#0f172a;border:1px solid rgba(255,255,255,0.08);border-radius:12px;overflow:hidden;">
                                    ...
                                    <input type="number" name="nilai_kontrak" required class="form-control border-0 text-white"
                                           style="background:transparent;box-shadow:none;height:50px;"
                                           placeholder="Masukkan nominal angka saja" value="{{ old('nilai_kontrak') }}">
                                </div>
                            </div>

                            {{-- Section 3: Dokumen --}}
                            <div class="col-md-6">
                                <label class="form-label text-secondary" style="font-size:12px;font-weight:600;">UPLOAD FILE PO</label>
                                <div class="p-3 rounded-4" style="background:rgba(255,255,255,0.02); border:1px dashed rgba(255,255,255,0.1);">
                                    ...
                                    <small class="text-muted d-block mt-1" style="font-size:10px;">Format: PDF, JPG, PNG (Max 5MB)</small>
                                </div>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label text-secondary" style="font-size:12px;font-weight:600;">UPLOAD FILE SPK</label>
                                <div class="p-3 rounded-4" style="background:rgba(255,255,255,0.02); border:1px dashed rgba(255,255,255,0.1);">
                            ...
                            <div class="col-12">
                                <label class="form-label text-secondary" style="font-size:12px;font-weight:600;">KETERANGAN TAMBAHAN</label>
                                <textarea name="keterangan" rows="3" class="form-control"
                                          ...
                                          placeholder="Catatan internal untuk kontrak ini...">{{ old('keterangan') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-5 pt-4" style="border-top:1px solid rgba(255,255,255,0.07);">
                            ...
                            <button type="submit" class="btn px-5 fw-bold"
                                ...
                                <i class="bi bi-file-earmark-check-fill me-2"></i>Simpan Kontrak
                            </button>
                        </div>

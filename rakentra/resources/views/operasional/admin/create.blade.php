...
<div class="container-fluid">
    ...
    <div class="mb-4">
        ...
        <p class="text-secondary mb-0">
            Tambahkan data operasional alat berat
        </p>
    ...
    <div class="card border-0 shadow-sm"
        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('operasional.store') }}"
                  method="POST">
                        ...
                        <select name="mobilisasi_id"
                            ...
                            @foreach($mobilisasis as $mobilisasi)
                                ...
                                <option value="{{ $mobilisasi->id }}"
                                    {{ old('mobilisasi_id') == $mobilisasi->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select name="status_unit"
                            ...
                            <option value="standby"
                                {{ old('status_unit') == 'standby' ? 'selected' : '' }}>
                            ...
                            <option value="operasional"
                                {{ old('status_unit') == 'operasional' ? 'selected' : '' }}>
                            ...
                            <option value="maintenance"
                                {{ old('status_unit') == 'maintenance' ? 'selected' : '' }}>
                            ...
                            <option value="rusak"
                                {{ old('status_unit') == 'rusak' ? 'selected' : '' }}>

...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
            <h4 class="fw-bold text-white mb-0">Edit Tagihan</h4>
            <small class="text-secondary">Perbarui data invoice: <span class="text-white">{{ $tagihan->nomor_tagihan }}</span></small>
        </div>
    </div>
                    ...
                    <form action="{{ route('tagihan.update', $tagihan->id) }}" method="POST">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-8">
                                ...
                                <select name="kontrak_id" required class="form-select"
                                    ...
                                    @foreach($kontraks as $kontrak)
                                        <option value="{{ $kontrak->id }}" {{ old('kontrak_id', $tagihan->kontrak_id) == $kontrak->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="status_tagihan" required class="form-select"
                                    ...
                                    @foreach(['pending' => 'Pending', 'dibayar' => 'Dibayar', 'jatuh_tempo' => 'Jatuh Tempo'] as $val => $label)
                                        <option value="{{ $val }}" {{ old('status_tagihan', $tagihan->status_tagihan) == $val ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group" style="background:#0f172a;border:1px solid rgba(255,255,255,0.08);border-radius:12px;overflow:hidden;">
                                    ...
                                    <input type="number" id="subtotal" name="subtotal" required class="form-control border-0 text-white"
                                           ...
                                           value="{{ old('subtotal', $tagihan->subtotal) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="keterangan" rows="3" class="form-control"
                                          ...
                                          placeholder="Keterangan rincian biaya atau catatan transfer...">{{ old('keterangan', $tagihan->keterangan) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-5 pt-4" style="border-top:1px solid rgba(255,255,255,0.07);">
                            ...
                            <button type="submit" class="btn px-5 fw-bold"
                                ...
                                <i class="bi bi-cloud-arrow-up-fill me-2"></i>Update Tagihan
                            </button>
                        </div>

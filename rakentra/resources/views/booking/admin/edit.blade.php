...
<div class="container-fluid">
    ...
    <div class="mb-4">
        ...
        <p class="text-secondary mb-0">
            Perbarui data booking alat berat
        </p>
                ...
                <div class="row">
                        ...
                        <select name="pelanggan_id"
                            ...
                            @foreach($pelanggans as $pelanggan)
                                ...
                                <option value="{{ $pelanggan->id }}"
                                    {{ old('pelanggan_id', $booking->pelanggan_id) == $pelanggan->id ? 'selected' : '' }}>
                        ...
                        <select name="alat_id"
                            ...
                            @foreach($alats as $alat)
                                ...
                                <option value="{{ $alat->id }}"
                                    {{ old('alat_id', $booking->alat_id) == $alat->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <select name="status"
                            ...
                            <option value="disetujui"
                                {{ old('status', $booking->status) == 'disetujui' ? 'selected' : '' }}>
                                Disetujui
                            </option>

                            <option value="berjalan"
                                {{ old('status', $booking->status) == 'berjalan' ? 'selected' : '' }}>
                                Berjalan
                            </option>

                            <option value="selesai"
                                {{ old('status', $booking->status) == 'selesai' ? 'selected' : '' }}>
                                Selesai
                            </option>

                            <option value="dibatalkan"
                                {{ old('status', $booking->status) == 'dibatalkan' ? 'selected' : '' }}>
                                Dibatalkan
                            </option>
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <textarea name="keterangan"
                                  ...
                                  style="background:#1e293b;
                                         border:none;
                                         border-radius:14px;">{{ old('keterangan', $booking->keterangan) }}</textarea>
